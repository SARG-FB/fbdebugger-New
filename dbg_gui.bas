...
private sub menu_enable()
	...
	SetStateMenu(HMenuvar,MNTHRDCHG,flag)

	SetStateMenu(HMenuthd,MNTHRDCHG,flag)
	SetStateMenu(HMenuthd,MNTHRDKLL,flag)
	SetStateMenu(HMenuthd,MNTHDIDLE,flag)
...
''menu proc/var
	...
	MenuBar(HMenuvar)
	MenuItem(MNTHRDCHG,HMenuvar, "Select thread")
...
''menu thread
	...
	MenuItem(MNTHDIDLE,HMenuthd, "Mark thread as idle")
...
private sub gui_init()
	...
	statusbar_text(KSTBTHS,"RSBI=00/00/00/00")
